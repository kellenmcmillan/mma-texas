...
fromProjectsDatabase
    ...
    var checkIfArrayIsUnique = function(myArray) {
        ...
        var get_notification_tokens = function(){
            if($rootScope.me){
                ...
                messaging.getToken().then(function(currentToken) {
                    if (currentToken) {
                        /////////////// Have to refactor to check if a token exists. if not add new one
                        if($rootScope.me.notification){
                            if($rootScope.me.notification.ids){
                                var currentIds = $rootScope.me.notification.ids;
                                var idsIfTokenAdded = [];
                                idsIfTokenAdded.push(currentIds);
                                idsIfTokenAdded.push(currentToken);
                                if(checkIfArrayIsUnique(idsIfTokenAdded) == false){
