...
$http){
    ...
    ////////////////////////////////// Firebase References
    var imageBucket = firebaseStorage.ref().child('media/images');
    var videoBucket = firebaseStorage.ref().child('media/video');
    var fileBucket = firebaseStorage.ref().child('media/files');
