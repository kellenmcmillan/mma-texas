...
$http){
    ...
    ///////////////////////////////////////////////////// task.link
    ///////////////////////////////////////////////////// task.user_generated
    ///////////////////////////////////////////////////// task.manually_triggered
    ///////////////////////////////////////////////////// task.reoccuring
    ///////////////////////////////////////////////////// task.delivery_medium
    ///////////////////////////////////////////////////// task.user_generated_action
    ...
    ///////////////////////////////////////////////////// task.in_app_dialog_media_source
    ...
    var nextMonthIsNewYear = next_month_plus_one < 12 ? true : false;
    ...
    function compileMonth (month, year) {
        ...
        var this_date = new Date(year, workingMonth, 0);
        month_var.date = this_date;
        var first_day = this_date.getDay();
        month_var.year = year;
        month_var.number_of_days = new Date(year, month, 0).getDate();
        month_var.month_number = month - 1;
        month_var.first_day = this_date.getDay();
        return month_var;
    }
    // build month object
    ...
    function compileMonthAlg(monthObj){
        ...
        var getDayOfWeek = function(day, month, year){
            var working_date = new Date(month, day, year);
            var result = working_date.getDay();
            return result;
        }

        for (var i = monthObj.first_day; i < monthObj.number_of_days - monthObj.first_day; i++) {

            var compiled_day = {};
            compiled_month[wk_idx] = [];
            compiled_day.day = getDayOfWeek(i, monthObj.month_number, monthObj.year);
            compiled_day.date = new Date(i, monthObj.month_number, monthObj.year);
            compiled_month[wk_idx].push(compiled_day);
            
            if (compiled_day.day === 6){
                wk_idx++;
            }

        }

        console.log(JSON.stringify(compiled_month));
    ...
    $rootScope.createTask = function(task){
        ...
        ///////////// Next Month
        var nextMonth;
        if (nextMonthIsNewYear) {
           nextMonth = compileMonth(1, next_year); 
        } else {
           nextMonth = compileMonth(0, this_year); 
        }
        ///////////// Next Month

        // build this and next months object

        var this_month = compileMonthAlg(thisMonth);
        var next_month = compileMonthAlg(nextMonth);
