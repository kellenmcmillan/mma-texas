...
$http){
    ...
    $rootScope.createTask = function(task){
        ...
        if(task.runDay){
            targetInitialDay = task.runDay;
            console.log("target day initially " + targetInitialDay + " target date initially " + targetDate);
        }
