...
$http){
    ...
    var nextMonthIsNewYear = next_month_plus_one < 12 ? false : true;
    ...
    function compileMonth (month, year) {
        ...
        month.year = year;
        month.number_of_days = new Date(year, month, 0).getDate();
        month.month_number = month - 1;
        month.first_day = month.date.getDay();
        return month;
    }
    // build month object
    ...
    function compileMonthAlg(monthObj){
        ...
        for (var i = month.first_day; i < month.number_of_days - month.first_day; i++) {

            var compiled_day = {};
            compiled_month[wk_idx] = [];
            compiled_day.day = getDayOfWeek(i, monthObj.month_number, month.year);
            compiled_day.date = new Date(i, monthObj.month_number, month.year);
