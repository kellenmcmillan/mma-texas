...
$http){
    ...
    var initDate = function(){
        ...
        $rootScope.this_month = compileMonthAlg(thisMonth);
        $rootScope.next_month = compileMonthAlg(nextMonth);
    }
    initDate();
    ...
    $rootScope.createTask = function(task){
        ...
        if (task.isReoccuring){
            ...
            if (task.reoccuring_week){
                var working_week = [];
                angular.forEach($rootScope.this_month, function(value, key) {
                    var days_in_month = value;
                    angular.forEach(days_in_month, function(value, key) {
                        if(value.week === task.reoccuring_week){
                            working_week.push(value);
                        }
                    });
                });
