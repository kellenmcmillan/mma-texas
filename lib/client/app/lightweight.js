...
$http){
    ...
    const permission_requested = false;
        ...
        messaging.requestPermission().then(function() {
            ...
            messaging.getToken().then(function(currentToken) {
                if (currentToken) {
                    ...
                    console.log("device token " + JSON.stringify(currentToken));
                } else {
    ...
    messaging.onTokenRefresh(function() {
        messaging.getToken().then(function(refreshedToken) {
            ...
            console.log("refreshed device token " + JSON.stringify(refreshedToken));
            // ...
        }).catch(function(err) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                task.on('state_changed',
                    ...
                    function complete(){
                        ...
                        var storeMyUploadedFile = usersBucket.child($rootScope.me.id + "/files/" + fileObj.uploadID).set(fileObj);
                        // This is where we'll update the users file model with $scope.$apply()
    ...
    $rootScope.addPage = function(type, data){
        ...
        switch(type){
            ...
            case "project":
                ...
                var task = tagArray.$add(tagObj);
                $rootScope.taglist.push(tagObj);
                new_page_data.data.tag = data.title;
