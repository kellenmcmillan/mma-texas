...
$http){
    ...
    $rootScope.deleteUser = function(user){
        ...
        $http({
            url: ("https://us-central1-mma-texas.cloudfunctions.net/deleteUser"),
            method: 'POST',
            data: data
        })
    ...
    $rootScope.createTask = function(task){
        ...
        if (task.isReoccuring){
            ...
            if (task.run_week){
                for (var i = 0; i < this_month.length; i++) {
                    ...
                    if(this_day.week === task.run_week && this_day.day === task.run_day){
                        ...
                        console.log("clock time in create task " + clock_time);
            ...
            if (!task.reoccuring_date && task.run_week){
    ...
    $rootScope.clearForm = function(form){
        ...
        $rootScope.blogForm = {};
        $rootScope.createTaskForm.$setPristine();
        $rootScope.createTaskForm..$setUntouched();
    }
