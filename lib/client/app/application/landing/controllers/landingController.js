...
$window
    ...
    var news_post_window = $timeout(function(){
    	...
    	$scope.panel_swipe=function(a){max_swipe=$scope.news_post_width,"left"===a?0===value?(value=Math.abs(value)+1,$scope.amount_to_slide=-value*$scope.news_panel_slide_increment+"%"):0!=value&&value!=max_swipe?(value+=1,$scope.amount_to_slide=-value*$scope.news_panel_slide_increment+"%"):(value=0,$scope.amount_to_slide=-value*$scope.news_panel_slide_increment+"%"):0===value?(value=max_swipe,$scope.amount_to_slide=-value*$scope.news_panel_slide_increment+"%"):(value-=1,$scope.amount_to_slide=-value*$scope.news_panel_slide_increment+"%")};
    }, 1000);
