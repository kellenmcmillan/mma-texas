...
$routeParams)
{
    ...
    var compile_rows_of_projects = function(list){
        ...
        container.panel_swipe = function(a){container.max_swipe=container.panel_width-1,"left"===a?0===value?(value=Math.abs(value)+1,container.amount_to_slide=-value*container.slide_increment+"%"):0!=value&&value!=container.max_swipe?(value+=1,container.amount_to_slide=-value*container.slide_increment+"%"):(value=0,container.amount_to_slide=-value*container.slide_increment+"%"):0===value?(value=container.max_swipe,container.amount_to_slide=-value*container.slide_increment+"%"):(value-=1,container.amount_to_slide=-value*container.slide_increment+"%")};
        container.data = list;
        return container;
    }
    // returns virtual panel properties and methods
    ...
    $rootScope.tablet = $rootScope.window_width < 900 && $rootScope.window_width > 600;
