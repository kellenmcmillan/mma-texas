...
$routeParams)
{
    ...
    var compile_rows_of_projects = function(list){
        ...
        $timeout(function(){
            ...
            var container = {};
            container.min_swipe = container_results.min_swipe;
